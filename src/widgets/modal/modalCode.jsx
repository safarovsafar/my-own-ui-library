...
export default function ModalCode() {
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 50 }}
            ...
            <p className='text-[30px] font-semibold'>Modal</p>
            <hr className='mt-2' />
            <p className='mt-2'>Simple MOdal in react</p>
            <p className='mt-[100px]'>Modal is a component that is used in various cases</p>
            ...
            <p className='text-[23px] font-bold mt-[20px]'>Basic Modal</p>
            ...
            <div className='w-[90%] m-auto mt-[30px] hover:border-cyan-600 hover:shadow-2xl rounded-2xl pl-20  p-4 border'>
                <p className='text-orange-400'>{`<Modal>`}</p>
